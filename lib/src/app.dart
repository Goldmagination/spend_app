...
class _MoneyGoalTrackerState extends State<MoneyGoalTracker>
          ...
          content: Form(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                border: OutlineInputBorder(borderRadius: BorderRadius.circular(8.0)), // Consistent border
              ),
          ...
          actions: <Widget>[
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: Theme.of(context).primaryColor, // Consistent primary color
  ...
  void _showAddFromItemsBottomSheet() {
    ...
    showModalBottomSheet(
      context: context,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(16.0))), // Rounded top corners
      builder: (BuildContext context) {
        return Padding(
          padding: const EdgeInsets.symmetric(vertical: 16.0, horizontal: 8.0), // Main padding for the sheet's content
          child: Column(
            mainAxisSize: MainAxisSize.min,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              Padding(
                padding: const EdgeInsets.fromLTRB(16.0, 8.0, 16.0, 12.0), // Title padding
                child: Text(
              ...
              Divider(height: 1, thickness: 1.5, indent: 8, endIndent: 8), // Slightly thicker divider
              LimitedBox(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return ListTile(
                      contentPadding: EdgeInsets.symmetric(horizontal: 24.0, vertical: 8.0), // Increased padding
                      leading: Icon(Icons.sell_outlined, color: Theme.of(context).colorScheme.secondary),
                      title: Text(article.name, style: TextStyle(fontWeight: FontWeight.w500)),
                      subtitle: Text('€${article.price.toStringAsFixed(2)}', style: TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant)),
                      onTap: () {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 30),
                      Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 8.0), // Consistent padding with main card
                        child: Column(
                          ...
                          children: [
                            ElevatedButton.icon(
                              ...
                              onPressed: _highlightedGoal != null ? _showAddCustomAmountDialog : null,
                              style: ElevatedButton.styleFrom(
                                backgroundColor: Colors.green.shade600, // Slightly darker green
                                foregroundColor: Colors.white,
                                padding: EdgeInsets.symmetric(vertical: 14),
                                textStyle: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, fontFamily: 'Roboto'),
                            ...
                            ElevatedButton.icon(
                              ...
                              onPressed: _highlightedGoal != null && _highlightedGoal!.articles.isNotEmpty 
                            ...
                            SizedBox(height: 20), // Standardized spacing (slightly more before divider)
                            Divider(thickness: 1),
                            SizedBox(height: 12), // Standardized spacing
                            OutlinedButton.icon(
                              icon: Icon(Icons.refresh, size: 20),
                              label: Text('Reset Goal', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, fontFamily: 'Roboto')),
                              onPressed: _highlightedGoal != null ? resetGoal : null,
                            ...
                            SizedBox(height: 12), // Standardized spacing
                            ElevatedButton.icon(
                              icon: Icon(Icons.display_settings_outlined, size: 20),
                              label: Text('Display Mode', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, fontFamily: 'Roboto')),
                            onPressed: () {
                              showDialog(
                                context: context,
                                builder: (BuildContext context) {
